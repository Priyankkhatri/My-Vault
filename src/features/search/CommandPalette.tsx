...
export function CommandPalette() {
 ...
 className="relative w-full max-w-md border border-vault-border overflow-hidden"
 >
 {/* Search input */}
 ...
 className="flex-1 text-sm text-vault-text placeholder:text-vault-text-muted"
 />
 <kbd className="text-[10px] text-vault-text-muted px-1.5 py-0.5 border border-vault-border">ESC</kbd>
 </div>
 ...
 selectedIndex === i ? ' text-vault-gold' : ''
 }`}
 >
 ...
 className={`w-full flex items-center gap-3 px-3 py-2 text-left cursor-pointer ${
 selectedIndex === globalIndex ? ' text-vault-gold' : ''
 }`}
 >
 ...
 <kbd className="px-1 text-[9px]">â†‘â†“</kbd> Navigate
 </span>
 <span className="flex items-center gap-1 text-[10px] text-vault-text-muted">
 <kbd className="px-1 text-[9px]">â†µ</kbd> Select
 </span>
 <span className="flex items-center gap-1 text-[10px] text-vault-text-muted">
 <kbd className="px-1 text-[9px]">ESC</kbd> Close
 </span>
 </div>
 </motion.div>
 </div>
