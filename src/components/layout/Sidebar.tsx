...
import { LayoutDashboard, Lock, ShieldCheck, Settings, LogOut, User } from 'lucide-react';
...
export function Sidebar() {
  ...
  return (
    <aside className="fixed left-0 top-0 h-full w-56 bg-[#F9FAFB] border-r border-gray-200 flex flex-col z-40 selection:bg-teal-100">
      {/* Brand */}
      <div className="h-16 flex items-center gap-2.5 px-6 shrink-0 mt-2">
