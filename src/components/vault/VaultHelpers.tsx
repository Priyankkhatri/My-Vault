...
export function getCategoryBg(type: VaultCategory) {
 switch (type) {
 case 'password': return ' border-vault-primary-100';
 case 'address': return ' border-blue-100';
 case 'card': return ' border-purple-100';
 case 'note': return ' border-emerald-100';
 case 'document': return ' border-orange-100';
 }
}
